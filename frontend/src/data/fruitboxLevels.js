export const fruitboxLevels = [
  {
    ...
    acceptedAnswers: ['justify-content: flex-end;', 'justify-content:flex-end'],
  ...
  },
  {
    ...
    starterCode: 'display: flex;',
    acceptedAnswers: ['justify-content: space-between;', 'justify-content:space-between'],
  ...
  },
  {
    ...
    starterCode: 'display: flex;\nheight: 100%;',
    acceptedAnswers: ['align-items: center;', 'align-items:center'],
  ...
  },
  {
    ...
    starterCode: 'display: flex;\nheight: 100%;',
    acceptedAnswers: ['align-items: flex-end;', 'align-items:flex-end'],
  ...
  },
  {
    ...
    acceptedAnswers: ['flex-direction: row-reverse;', 'flex-direction:row-reverse'],
  ...
  },
  {
    ...
    starterCode: 'display: flex;\nheight: 100%;',
    acceptedAnswers: ['flex-direction: column;', 'flex-direction:column'],
    hint: 'column makes flex vertical.',
    xpReward: 20,
    fruits: [
      { type: '🍎', order: 1, targetY: 'top' },
      { type: '🍌', order: 2 },
    ],
  },
  {
    ...
    starterCode: 'display: flex;',
    acceptedAnswers: ['justify-content: space-around;', 'justify-content:space-around'],
  ...
  },
  {
    ...
    starterCode: 'display: flex;',
    acceptedAnswers: ['justify-content: space-evenly;', 'justify-content:space-evenly'],
  ...
  },
  {
    ...
    starterCode: 'display: flex;\nwidth: 100%;',
    acceptedAnswers: ['flex-wrap: wrap;', 'flex-wrap:wrap'],
  ...
  },
  {
    ...
    starterCode: 'display: flex;',
    acceptedAnswers: ['.banana { order: 1; }', '.grape { order: 2; }', '.apple { order: 3; }'],
    hint: 'order property changes visual order without changing HTML.',
    xpReward: 25,
    fruits: [
      { type: '🍎', class: 'apple', order: 3 },
      { type: '🍌', class: 'banana', order: 1 },
      { type: '🍇', class: 'grape', order: 2 },
    ],
  },
  {
    id: 12,
  ...
  },
  {
    ...
    starterCode: 'display: flex;',
    acceptedAnswers: ['gap: 1rem;', 'gap:1rem', 'gap: 2rem;', 'gap:2rem'],
  ...
  },
  {
    ...
    instruction:
      'Wrap fruits with gap, reverse column direction, strawberry bottom-right using order.',
    starterCode: 'display: flex;\nheight: 100%;',
    acceptedAnswers: [
