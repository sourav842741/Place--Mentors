export const companyData = {
  ...
  apple: {
    ...
    hiring: {
      pattern: [
        ...
        { round: "Technical Interviews (3-5)", details: "Deep Dive into OS, Memory, and Swift/C++" },
  ...
  google: {
    ...
    overview: {
      ...
      description: "Google is a global leader in search, advertising, cloud computing, and hardware, driven by a mission to organize the world's information.",
    ...
    hiring: {
      pattern: [
        ...
        { round: "Onsite Rounds (4-5)", details: "Coding, Googleyness (Behavioral), System Design" }
      ],
      difficulty: "Very Hard",
    ...
    resources: {
      youtube: [
        { title: "Google Interview Prep by Striver", link: "https://youtube.com/playlist?list=google_prep" }
      ],
      coding: [
        { platform: "LeetCode Google", link: "https://leetcode.com/company/google/" }
      ],
      aptitude: [
  ...
  accenture: {
    ...
    overview: {
      ...
      description: "A professional services company providing strategy, consulting, digital, technology and operations services.",
      industry: "Consulting, IT Services",
      headquarters: "Dublin, Ireland"
    },
    hiring: {
      pattern: [
        { round: "Cognitive & Technical", details: "English, Critical Reasoning, MS Office, Pseudocode" },
    ...
    resources: {
      ...
      coding: [
        { platform: "GFG Accenture", link: "https://geeksforgeeks.org/accenture/" }
      ],
      aptitude: [
        { platform: "Indiabix", link: "https://indiabix.com" }
      ]
  ...
  infosys: {
    ...
    resources: {
      youtube: [
        { title: "Infosys DSE Prep", link: "https://youtube.com/infosys_prep" }
      ],
      coding: [
        { platform: "InfyTQ Portal", link: "https://infytq.onwingspan.com/" }
      ],
      aptitude: [
        { platform: "PrepInsta", link: "https://prepinsta.com/infosys/" }
      ]
    },
    cutoff: {
    ...
    overview: {
      ...
      description: "Uber is a technology provider that matches riders with drivers, and customers with restaurants and delivery service providers.",
    ...
    examTimeline: { expected: "August-October 2025", lastYear: "August 2024", note: "Referrals work best" },
    preparation: {
      roadmap: "Advanced DSA → High Level Design → LLD",
      topics: {
        mustDo: ["Graphs", "DP", "Concurrency"],
        aptitude: { quantitative: ["Logistics Math"], logical: ["Puzzles"], verbal: ["Business English"] },
        coreSubjects: { os: ["Multithreading"], dbms: ["PostgreSQL", "Scaling"], oops: ["SOLID Principles"] },
        advanced: { systemDesign: ["Design Uber", "Location Tracking"], csConcepts: ["Distributed Systems"] }
      },
  ...
  netflix: {
    ...
    preparation: {
      ...
      topics: {
        ...
        aptitude: { quantitative: ["N/A"], logical: ["Complex scenarios"], verbal: ["Cultural Alignment"] },
        coreSubjects: { os: ["Linux Internals"], dbms: ["Cassandra", "NoSQL"], oops: ["Architecture Patterns"] },
  ...
  zomato: {
    ...
    examTimeline: { expected: "June-August 2025", lastYear: "July 2024", note: "Active on LinkedIn" },
    preparation: {
  ...
  swiggy: {
    ...
    examTimeline: { expected: "July-September 2025", lastYear: "August 2024", note: "Campus hiring is active" },
    preparation: {
  ...
  oracle: {
    ...
    overview: {
      ...
      description: "Oracle is a cloud technology company that provides organizations around the world with computing infrastructure and software.",
    ...
    examTimeline: { expected: "August-October 2025", lastYear: "September 2024", note: "Regular on-campus" },
    preparation: {
  ...
  morganStanley: {
    ...
    overview: {
      ...
      description: "A leading global financial services firm providing investment banking and wealth management services.",
      industry: "Investment Banking, FinTech",
      headquarters: "New York, USA"
    },
    hiring: {
    ...
    examTimeline: { expected: "July-September 2025", lastYear: "August 2024", note: "Off-campus hiring exists" },
    preparation: {
      ...
      topics: {
        ...
        advanced: { systemDesign: ["Banking App Basics"], csConcepts: ["C++ STL/Java Collections"] }
      },
  ...
  samsung: {
    ...
    examTimeline: { expected: "August-October 2025", lastYear: "September 2024", note: "Regular on-campus for SDE" },
    preparation: {
      ...
      topics: {
        ...
        coreSubjects: { os: ["Processes", "Scheduling"], dbms: ["SQL Basics"], oops: ["Pointers in C++"] },
    ...
    cutoff: { coding: "1/1 Correct (Pass all test cases)", aptitude: "N/A", note: "SWC is the only gatekeeper" },
    strategy: {
  ...
  visa: {
    ...
    examTimeline: { expected: "August-October 2025", lastYear: "September 2024", note: "Visa CodeUrWay competition" },
    preparation: {
      roadmap: "DSA → OOPS → Payment Domain → SQL",
      topics: {
        mustDo: ["Strings", "Heaps", "Hashmaps"],
        aptitude: { quantitative: ["Probability"], logical: ["Puzzles"], verbal: ["Comprehension"] },
  ...
  deloitte: {
    ...
    overview: {
      ...
      description: "Leading global provider of audit and assurance, consulting, financial advisory, risk advisory, tax, and related services.",
      industry: "Consulting",
    ...
    examTimeline: { expected: "August-December 2025", lastYear: "September 2024", note: "Mass hiring" },
    preparation: {
      roadmap: "Aptitude → Communication → Case Studies",
      topics: {
        mustDo: ["Arrays", "Puzzles", "English"],
        aptitude: { quantitative: ["Profit/Loss"], logical: ["Syllogism"], verbal: ["Sentence Mastery"] },
  ...
  cisco: {
    ...
    overview: {
      ...
      description: "World leader in networking that transforms how people connect, communicate, and collaborate.",
    ...
    examTimeline: { expected: "August-October 2025", lastYear: "September 2024", note: "Cisco Ideathon competition" },
    preparation: {
  ...
  pwc: {
    ...
    examTimeline: { expected: "September-November 2025", lastYear: "October 2024", note: "On-campus focus" },
    preparation: {
      roadmap: "Aptitude → Case Study → HR Prep",
      topics: {
        mustDo: ["English", "Math", "Case Studies"],
        aptitude: { quantitative: ["Data Interpretation"], logical: ["Blood Relations"], verbal: ["RC"] },
  ...
  intel: {
    ...
    examTimeline: { expected: "August-October 2025", lastYear: "September 2024", note: "Hires for both HW and SW" },
    preparation: {
      roadmap: "Digital Electronics → OS → C++ → DSA",
      topics: {
        mustDo: ["C/C++", "OS Internals", "Computer Architecture"],
        aptitude: { quantitative: ["Numbers"], logical: ["Logic Gates"], verbal: ["Technical English"] },
  ...
  ibm: {
    ...
    examTimeline: { expected: "July-September 2025", lastYear: "August 2024", note: "Continuous hiring" },
    preparation: {
  ...
  walmart: {
    ...
    resources: {
      ...
      coding: [{ platform: "LeetCode Walmart", link: "https://leetcode.com/company/walmart-global-tech/" }],
      aptitude: [{ platform: "IndiaBIX", link: "https://indiabix.com" }]
    },
  ...
  jpmorgan: {
    ...
    overview: {
      ...
      description: "A leader in investment banking, financial services for consumers and small businesses.",
      industry: "Investment Banking, FinTech",
      headquarters: "New York, USA"
    },
    hiring: {
    ...
    examTimeline: { expected: "June-August 2025", lastYear: "July 2024", note: "Code for Good happens early" },
    preparation: {
    ...
    cutoff: { coding: "1.5/2 Correct", aptitude: "N/A", note: "Hackathon performance matters most" },
    strategy: {
  ...
  byjus: {
    ...
    examTimeline: { expected: "September-October 2025", lastYear: "October 2024", note: "Direct interviews" },
    preparation: {
  ...
  capgemini: {
    ...
    examTimeline: { expected: "August-October 2025", lastYear: "September 2024", note: "Mass hiring" },
    preparation: {
  ...
  goldmanSachs_India: {
    ...
    examTimeline: { expected: "July-August 2025", lastYear: "August 2024", note: "Engineering Campus Hiring Program" },
    preparation: {
      roadmap: "Math (Probability) → DSA → Puzzles",
      topics: {
        mustDo: ["Math", "DP", "Graphs"],
        aptitude: { quantitative: ["Probability", "Statistics"], logical: ["Puzzles"], verbal: ["RC"] },
  ...
  infosys_Lex: {
    ...
    examTimeline: { expected: "January-March 2025", lastYear: "February 2024", note: "InfyTQ portal" },
    preparation: {
  ...
  salesforce: {
    ...
    overview: {
      ...
      description: "The world's #1 CRM, helping companies connect with their customers in a whole new way.",
    ...
    resources: {
      ...
      coding: [{ platform: "LeetCode Salesforce", link: "https://leetcode.com/company/salesforce/" }],
      aptitude: [{ platform: "IndiaBIX", link: "https://indiabix.com" }]
    },
