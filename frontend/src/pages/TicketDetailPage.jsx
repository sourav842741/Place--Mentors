                    ...
                    >
                      ...
                      >
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className={`text-xs font-semibold ${isAdmin ? "text-purple-700 dark:text-purple-300" : "opacity-90"}`}>
                            {isAdmin
                              ? "Support Team"
                              : isMe
                              ? "You"
                          ...
                          <span className={`text-xs ml-auto ${isAdmin ? "text-gray-400" : "opacity-60"}`}>
            ...
            <div className="text-center py-6 text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800">
              ...
              {ticketDetail.status === "Solved" && (
                <p className="text-sm mt-1">
                  You can reopen it if the issue persists.
                </p>
              )}
            </div>
          )}
