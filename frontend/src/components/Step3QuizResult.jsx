...
function Step3Report({ result }) {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="w-full flex items-start gap-4 flex-wrap"
        >
          <button
            onClick={() =>
              navigate("/history")
      ...
      >
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <p
              className="text-gray-400 dark:text-gray-500 mt-3 text-sm"
            >
              Out of 10
            </p>
          ...
          >
            <h3
              className="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-6"
            >
              Skill Evaluation
            </h3>
              ...
              {skills.map(
                (s, i) => (
                  <div key={i}>
                    ...
                    <div
                      className="bg-gray-200 dark:bg-gray-700 h-2 rounded-full"
                    >
                      <div
