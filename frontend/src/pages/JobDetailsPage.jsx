...
const JobDetailsPage = () => {
  ...
  if (!job) {
    return (
      <div className="pt-16 md:pl-64 min-h-screen bg-gradient-to-br from-slate-50 to-indigo-50 flex items-center justify-center">
        <Navbar />
  ...
  return (
    ...
    <div className="pt-16 md:pl-64 min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <div className="max-w-6xl mx-auto p-4 md:p-8">
        {/* Hero Header */}
        <div className="bg-gradient-to-r from-indigo-600 to-purple-200 rounded-3xl p-8 md:p-12 text-black mb-8 shadow-2xl">
          <div className="flex flex-col lg:flex-row lg:items-start gap-6 lg:gap-12">
            ...
            <div className="flex flex-wrap gap-3 items-center">
              ...
              <Button variant="outline" size="lg" className="text-black border-white/80 hover:bg-white/20 font-semibold" onClick={shareJob}>
              ...
              >
                <Star className={`mr-2 h-5 w-5 ${isBookmarked ? 'fill-yellow-300 text-yellow-300' : 'text-white/70'}`} />
          ...
          <div className="space-y-6">
            ...
            <Card className="shadow-lg sticky top-6">
              ...
              <CardContent className="space-y-4 text-sm">
                ...
                <Button className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700">
                  Visit Company
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-lg">
              ...
              <CardContent className="space-y-3">
                <Button variant="outline" size="sm" className="w-full justify-start" onClick={shareJob}>
                  <Share2 className="mr-2 h-4 w-4" />
                  Copy Link
                </Button>
