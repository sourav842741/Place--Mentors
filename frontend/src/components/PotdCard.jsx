      ...
      <CardContent className="flex flex-col justify-between flex-1 p-0 h-full">
        ...
        <div className="flex items-center justify-between">
          ...
          {locked ? (
            ...
            <button
              onClick={handleStart}
              className="flex items-center gap-2 px-5 py-2 rounded-full bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold hover:scale-105 transition"
            >
              Start
