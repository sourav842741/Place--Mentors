            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
              {Array(12)
                ...
                .map((_, i) => (
                  <div
                    key={i}
                    className="group bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl border border-white/20 dark:border-white/10 shadow-xl rounded-3xl p-6 space-y-4 animate-pulse hover:shadow-2xl transition-all"
                  >
  ...
  "
          >
            ...
            <div className="flex flex-col sm:flex-row gap-2 w-full lg:w-auto">
              <Button onClick={refetch} variant="outline" className="rounded-xl w-full sm:w-auto">
                  ...
                  >
                    <CardHeader className="pb-2">
                      <div className="flex justify-between items-start gap-2">
                        ...
                        <Badge
                          className={`text-xs ${badgeColors[difficulty]} transition-colors duration-300`}
                        >
                          {difficulty}
                        </Badge>
                      </div>
