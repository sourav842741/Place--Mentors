          ...
          {status !== "submitted" && (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="lg:col-span-5">
                      ...
                      <TabsContent value="testcases" className="mt-4">
                        <div className="space-y-4">
                          {problem?.testCases?.map((tc, i) => (
                            ...
                            >
                              <h5 className="font-semibold mb-3">Test Case {i + 1}</h5>
                ...
                {finalOpponent && (
                  <Card
                    className="mt-6 border border-gray-200 dark:border-white/10 
                ...
                {isRunning && status !== "submitted" && (
                  <Card className="border-0 bg-white/80 dark:bg-gray-800/90 backdrop-blur-xl animate-pulse">
                    <CardContent className="p-8 text-center">
                      ...
                      <p className="text-gray-500 mt-1">Please wait for test results</p>
                    </CardContent>
                  </Card>
                )}
              </div>
