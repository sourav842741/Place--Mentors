        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="flex items-start justify-between flex-wrap gap-4">
            ...
            <div className="text-right">
              ...
              <Button onClick={handlePDFDownload} disabled={pdfLoading} className="gap-2">
                {pdfLoading ? (
    ...
    border border-gray-200 dark:border-white/10 "
          >
            ...
            <CardContent className="p-0">
              <div
                className="prose prose-lg max-w-none p-8 lg:p-12 
dark:prose-invert 
!bg-transparent 
              ...
              <CardContent>
                ...
                rounded-lg border border-gray-200 dark:border-white/10"
                    >
                      ...
                      <p className="text-gray-700 dark:text-gray-300">{chart}</p>
                    </div>
                  ))}
                </div>
