      ...
      <div className="min-h-screen bg-linear-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-900 lg:ml-64 md:ml-64 p-6 mt-17 transition-colors">
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold text-indigo-600 mb-4">About Practice Mentor 🚀</h1>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Practice Mentor is an AI-powered placement preparation platform designed to help
              students crack top company interviews with structured guidance, real-world practice,
              and smart insights.
            </p>
          </div>
          ...
          {/*  HOW IT WORKS */}
          <div>
            <h2 className="text-2xl font-bold mb-6 text-gray-800">⚙️ How It Works</h2>
