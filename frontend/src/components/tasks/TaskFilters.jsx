  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        {/* Sort */}
        <div className="space-y-1.5">
          <p className="text-xs font-medium uppercase tracking-wider text-muted-foreground">Sort</p>
        ...
        <div className="flex flex-wrap gap-2 pt-2">
          {categoryFilter && (
            <Badge variant="secondary">
              ...
              <X className="w-3 h-3 ml-1 cursor-pointer" onClick={() => setCategoryFilter("")} />
            </Badge>
          )}
          ...
          {priorityFilter && (
            <Badge variant="secondary">
              ...
              <X className="w-3 h-3 ml-1 cursor-pointer" onClick={() => setPriorityFilter("")} />
            </Badge>
          )}
        </div>
      )}
