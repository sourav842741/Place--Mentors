...
export default function PlannerHistory() {
  ...
  return (
    <>
      <Navbar />
      <div className="pt-16 md:pl-64 p-4 sm:p-6 lg:p-20 lg:ml-60 bg-gray-50 min-h-screen">
              ...
              <Card className="mb-8">
                <CardContent className="p-6">
                  <Button
                    ...
                    className="bg-linear-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 flex items-center gap-2 px-6 rounded-xl shadow-lg transition-all hover:shadow-xl w-full md:w-auto"
                  >
            ...
            {planners.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 h-full">
                {planners.map((planner) => (
                  <Card
                    key={planner._id}
                    className="h-full hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group"
                  >
                    <CardHeader className="pb-3">
                      <CardTitle className="flex items-start justify-between">
                        <span className="font-bold text-base sm:text-lg line-clamp-1 pr-2">
                          {planner.goal}
                        </span>
                        <Badge
                          variant="secondary"
