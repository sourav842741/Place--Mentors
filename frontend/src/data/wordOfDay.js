...
export const WORDS = [
  ...
  },
  {
    ...
    example: "I shared a summary after the meeting.",
    difficulty: "Beginner",
    category: "Professional emails",
  },
  {
    word: "clarification",
    meaning: "Extra information to resolve confusion.",
    example: "I requested clarification on the scope.",
    difficulty: "Intermediate",
    category: "Professional emails",
  },
  {
    word: "response time",
    meaning: "How quickly a reply is provided.",
    example: "Improving response time improves customer trust.",
    difficulty: "Intermediate",
    category: "Workplace conversations",
  },
  {
    word: "customer-centric",
    meaning: "Focused on customer needs and experiences.",
    example: "We adopted a customer-centric approach.",
    difficulty: "Advanced",
    category: "Corporate communication",
  },
  {
    word: "effort",
    meaning: "Work put into a task.",
    example: "The effort shows in the final deliverable.",
    difficulty: "Beginner",
    category: "Workplace",
  },
  {
    word: "impact",
    meaning: "The effect or influence of an action.",
    example: "I focus on high-impact tasks first.",
    difficulty: "Beginner",
    category: "Workplace",
  },
  {
    word: "value",
    meaning: "The usefulness or importance of something.",
    example: "I deliver value through measurable outcomes.",
    difficulty: "Beginner",
    category: "Corporate communication",
  },
  {
    word: "leverage",
    meaning: "To use something effectively to gain advantage.",
    example: "We leveraged existing data to speed up analysis.",
    difficulty: "Advanced",
    category: "Corporate communication",
  },
  {
    word: "synergy",
    meaning: "Cooperation that produces a greater result.",
    example: "Cross-team synergy improved our results.",
    difficulty: "Advanced",
    category: "Workplace",
  },
  {
    word: "alignment",
    meaning: "Agreement on goals and direction.",
    example: "Alignment ensured a smooth execution.",
    difficulty: "Intermediate",
    category: "Corporate communication",
  },
  {
    word: "stakeholders",
    meaning: "People affected by decisions or outcomes.",
    example: "Stakeholders reviewed the plan before execution.",
    difficulty: "Advanced",
    category: "HR discussions",
  },
  {
    word: "requirements",
    meaning: "Things that must be included or achieved.",
    example: "We gathered requirements early to reduce rework.",
    difficulty: "Intermediate",
    category: "Professional emails",
  },
  {
    word: "specification",
    meaning: "Detailed instructions or description of what is needed.",
    example: "The specification clarified expected behavior.",
    difficulty: "Advanced",
    category: "Interview English",
  },
  {
    word: "understand",
    meaning: "To grasp the meaning or intention.",
    example: "I make sure I understand the problem before acting.",
    difficulty: "Beginner",
    category: "Interview English",
  },
  {
    word: "identify",
    meaning: "To recognize or determine.",
    example: "I identified the root cause of the issue.",
    difficulty: "Beginner",
    category: "Workplace",
  },
  {
    word: "analyze",
    meaning: "To study information carefully.",
    example: "We analyzed the data to confirm the hypothesis.",
    difficulty: "Intermediate",
    category: "Interview English",
  },
  {
    ...
    example: "I assessed risks and proposed a plan.",
    difficulty: "Intermediate",
    category: "Corporate communication",
  },
  {
    word: "evaluate",
    meaning: "To judge the value or quality.",
    example: "We evaluated options based on impact.",
    difficulty: "Intermediate",
    category: "Interview English",
  },
  {
    word: "conclusion",
    meaning: "A decision or judgment based on evidence.",
    example: "My conclusion was supported by evidence.",
    difficulty: "Advanced",
    category: "Interview English",
  },
  {
    word: "assumption",
    meaning: "Something taken as true without proof.",
    example: "We questioned assumptions to improve accuracy.",
    difficulty: "Intermediate",
    category: "Interview English",
  },
  {
    word: "evidence-based",
    meaning: "Based on facts and evidence.",
    example: "I use evidence-based reasoning in decision-making.",
    difficulty: "Advanced",
    category: "Corporate communication",
  },
  {
    word: "data-driven",
    meaning: "Using data to guide decisions.",
    example: "Our strategy was data-driven and measurable.",
    difficulty: "Advanced",
    category: "Corporate communication",
  },
  {
    word: "goal",
    meaning: "An intended result.",
    example: "I set clear goals and tracked progress.",
    difficulty: "Beginner",
    category: "Workplace",
  },
  {
    word: "objective",
    meaning: "A specific goal.",
    example: "Our objective was to improve interview success rate.",
    difficulty: "Intermediate",
    category: "Interview English",
  },
  {
    word: "priority",
    meaning: "A thing that is considered most important.",
    example: "Priority #1 is quality delivery.",
    difficulty: "Beginner",
    category: "Workplace",
  },
  {
    word: "urgency",
    meaning: "How quickly something needs to be addressed.",
    example: "We handled urgent items first without sacrificing quality.",
    difficulty: "Intermediate",
    category: "Workplace",
  },
  {
    word: "deadline",
    meaning: "The latest date/time by which something must be done.",
    example: "I manage deadlines with consistent planning.",
    difficulty: "Beginner",
    category: "Workplace",
  },
  {
    word: "timeline",
    meaning: "A schedule of dates for events.",
    example: "A clear timeline helps the team stay focused.",
    difficulty: "Beginner",
    category: "Professional emails",
  },
  {
    word: "milestones",
    meaning: "Important points in a timeline.",
    example: "Milestones help track progress.",
    difficulty: "Intermediate",
    category: "Workplace",
  },
  {
    word: "deliver",
    meaning: "To provide a result or service.",
    example: "I deliver on commitments.",
    difficulty: "Beginner",
    category: "Interview English",
  },
  {
    ...
    example: "Commitment is essential for reliability.",
    difficulty: "Beginner",
    category: "HR discussions",
  },
  {
    ...
    example: "I am reliable and communicate early about risks.",
    difficulty: "Beginner",
    category: "HR discussions",
  },
  {
    ...
    example: "Dependable delivery builds confidence.",
    difficulty: "Beginner",
    category: "HR discussions",
  },
  {
    word: "consistency",
    meaning: "Steady performance over time.",
    example: "Consistency beats intensity for long-term success.",
    difficulty: "Intermediate",
    category: "Interview English",
  },
  {
    word: "persistence",
    meaning: "Continuing to try even when facing difficulties.",
    example: "Persistence helped me improve interview performance.",
    difficulty: "Intermediate",
    category: "Interview English",
  },
  {
    word: "discipline",
    meaning: "The ability to follow rules and stay focused.",
    example: "Discipline supports consistent interview practice.",
    difficulty: "Advanced",
    category: "Communication",
  },
  {
    word: "focus",
    meaning: "Concentration on a specific task.",
    example: "Focus helps me produce high-quality work.",
    difficulty: "Beginner",
    category: "Workplace",
  },
  {
    ...
    example: "Clarity reduces misunderstandings during meetings.",
    difficulty: "Beginner",
    category: "Communication",
  },
  {
    word: "tone",
    meaning: "The attitude or style used in communication.",
    example: "Use a professional tone in emails.",
    difficulty: "Intermediate",
    category: "Professional emails",
  },
  {
    ...
    example: "A courteous response builds goodwill.",
    difficulty: "Beginner",
    category: "Professional emails",
  },
  {
    word: "polite",
    meaning: "Respectfully expressed.",
    example: "I kept my message polite and direct.",
    difficulty: "Beginner",
    category: "Professional emails",
  },
  {
    word: "respectful",
    meaning: "Showing respect toward others.",
    example: "Respectful communication prevents escalation.",
    difficulty: "Beginner",
    category: "Workplace conversations",
  },
  {
    word: "professional",
    meaning: "Appropriate for workplace context.",
    example: "Professional communication improves credibility.",
    difficulty: "Beginner",
    category: "Corporate communication",
  },
  {
    ...
    example: "Clear evidence makes your response credible.",
    difficulty: "Advanced",
    category: "Interview English",
  },
  {
    word: "convince",
    meaning: "To persuade.",
    example: "Your structure can convince the interviewer.",
    difficulty: "Intermediate",
    category: "Interview English",
  },
  {
    word: "persuasive",
    meaning: "Able to convince.",
    example: "A persuasive story includes context and outcomes.",
    difficulty: "Advanced",
    category: "Communication",
  },
  {
    word: "narrative",
    meaning: "A structured story or explanation.",
    example: "Use a narrative: problem, action, result.",
    difficulty: "Intermediate",
    category: "Interview English",
  },
  {
    word: "storytelling",
    meaning: "Presenting information as a story.",
    example: "Storytelling makes your experience memorable.",
    difficulty: "Advanced",
    category: "Interview English",
  },
  {
    word: "STAR method",
    meaning: "Situation, Task, Action, Result interview format.",
    example: "I used the STAR method to answer behavioral questions.",
    difficulty: "Intermediate",
    category: "Interview English",
  },
  {
    word: "behavioral",
    meaning: "Related to past experiences and actions.",
    example: "Behavioral questions ask how you handled real situations.",
    difficulty: "Beginner",
    category: "Interview English",
  },
  {
    word: "competency",
    meaning: "A skill or ability expected for a role.",
    example: "We discussed my competencies for the job.",
    difficulty: "Advanced",
    category: "HR discussions",
  },
  {
    word: "culture",
    meaning: "Shared values and behaviors in an organization.",
    example: "I align with your team culture and values.",
    difficulty: "Intermediate",
    category: "HR discussions",
  },
  {
    word: "values",
    meaning: "Principles that guide decisions and behavior.",
    example: "My values match the company’s values.",
    difficulty: "Beginner",
    category: "HR discussions",
  },
  {
    word: "growth mindset",
    meaning: "Belief that abilities can improve with effort.",
    example: "I have a growth mindset and learn from mistakes.",
    difficulty: "Intermediate",
    category: "Interview English",
  },
  {
    word: "learning agility",
    meaning: "Ability to learn quickly in new situations.",
    example: "Learning agility helps me adapt to changing roles.",
    difficulty: "Advanced",
    category: "Interview English",
  },
  {
    word: "mentorship",
    meaning: "Guidance from experienced people.",
    example: "Mentorship accelerated my professional growth.",
    difficulty: "Beginner",
    category: "Workplace",
  },
  {
    word: "coaching",
    meaning: "Guiding improvement through feedback.",
    example: "Coaching helped me refine my communication.",
    difficulty: "Intermediate",
    category: "Communication",
  },
  {
    word: "development",
    meaning: "Progress and growth of skills.",
    example: "Development plans support continuous improvement.",
    difficulty: "Beginner",
    category: "Workplace",
  },
  {
    word: "training",
    meaning: "Process of learning new skills.",
    example: "Training improved my confidence for the interview.",
    difficulty: "Beginner",
    category: "Workplace",
  },
  {
    word: "hand-off",
    meaning: "The transfer of work between people or teams.",
    example: "I ensured a smooth hand-off with documentation.",
    difficulty: "Intermediate",
    category: "Workplace conversations",
  },
...
const BASE_THEMES = [
  {
    category: "Interview English",
    roots: ["versatile", "confident", "grounded", "focused", "mindful"],
    difficulty: "Intermediate",
  },
  {
    category: "Professional emails",
    roots: ["acknowledge", "confirm", "request", "follow", "update"],
    difficulty: "Beginner",
  },
  {
    category: "Workplace",
    roots: ["collaborate", "coordinate", "streamline", "optimize", "sustain"],
    difficulty: "Advanced",
  },
  {
    category: "HR discussions",
    roots: ["evaluate", "recommend", "negotiate", "support", "mentor"],
    difficulty: "Intermediate",
  },
  {
    category: "Corporate communication",
    roots: ["articulate", "synthesize", "align", "justify", "communicate"],
    difficulty: "Advanced",
  },
];
...
const GENERIC_DICTIONARY = [
  {
    meaning: "To ensure something happens as planned.",
    example: "I follow up regularly to ensure alignment.",
    difficulty: "Beginner",
  },
  {
    meaning: "To reduce risk by preparing alternatives.",
    example: "We mitigated risk using a contingency plan.",
    difficulty: "Advanced",
  },
  {
    meaning: "To explain the reasoning in a clear way.",
    example: "I clarified the rationale behind my decision.",
    difficulty: "Intermediate",
  },
  {
    meaning: "To improve outcomes through repeated refinement.",
    example: "We iterated quickly based on feedback.",
    difficulty: "Intermediate",
  },
  {
    meaning: "To describe something in short, clear language.",
    example: "I kept the message concise and actionable.",
    difficulty: "Beginner",
  },
  {
    meaning: "To make information easier to understand.",
    example: "I added context to improve clarity.",
    difficulty: "Beginner",
  },
  {
    meaning: "To coordinate tasks so teams can work efficiently.",
    example: "Strong coordination reduced delays.",
    difficulty: "Advanced",
  },
  {
    meaning: "To take responsibility for results and follow through.",
    example: "I took ownership until the issue was resolved.",
    difficulty: "Intermediate",
  },
];
